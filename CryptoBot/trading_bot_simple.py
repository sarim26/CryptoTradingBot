"""
Main Trading Bot Module - Windows Compatible Version
Has all components and runs the main trading loop.
"""
...
class TradingBot:
    ...
    def select_buy_decision_mode(self) -> bool:
        ...
        print("\n2. Config-Based Decision (Traditional)")
        print("   - Uses fixed buy percentage from config settings")
        print("   - Simple and predictable")
        print(f"   - Current setting: -{config.BUY_DROP_PERCENTAGE}%")
        ...
        while True:
            try:
                ...
                print("\nUsing default: Config-Based Decision")
                return False
    ...
    def run(self):
        ...
        if self.use_ml_buy_decision:
            ...
            if not success:
                print("Falling back to config-based buy decisions")
                self.use_ml_buy_decision = False
    ...
    def display_menu(self):
        ...
        while True:
            ...
            if choice == '1':
                ...
                self.portfolio.display_annual_tax_summary()
            elif choice == '7':
                print("\nGoodbye!\n")
                break
            else:
