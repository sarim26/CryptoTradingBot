...
MEAN_SELL_PROFIT_PERCENT = 3  # Profit percentage from buy price to trigger sell
...
ROBUST_MEAN_LOOKBACK_HOURS = int(os.getenv('ROBUST_MEAN_LOOKBACK_HOURS', 14))  # 72 hours (3 days)
...
ML_MIN_BUY_PERCENTAGE = float(os.getenv('ML_MIN_BUY_PERCENTAGE', 1.0))  # Minimum buy percentage (0.5%)
